...
@Slf4j
@Tag(name = "用户模块", description = "注册、登录、个人信息、偏好设置、账号管理")
public class UserController {
    ...
    public Result<Void> logout(@RequestHeader(value = "authorization", required = false) String authHeader) {
        ...
        userService.logout(resolveToken(authHeader));
    ...
    public Result<UserSettingsVO> getSettings() {
        return Result.success(userService.getSettings(BaseContext.getCurrentUuid()));
    }
